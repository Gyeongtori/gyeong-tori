...
import org.jackpot.back.security.exception.AuthErrorCode;
...
import static org.jackpot.back.security.exception.AuthErrorCode.DIFFERENT_NUMBER;
import static org.jackpot.back.user.exception.UserErrorCode.ALREADY_IN_EMAIL;
...
public class EmailService {
    ...
    public void sendJoinCodeMail(String email){
        //이미 가입된 이메일인지 검증
        User user=userRepository.findByEmail(email).orElseThrow(()->new UserException(ALREADY_IN_EMAIL));
        sendCodeMail(email);
    }
    @Transactional
