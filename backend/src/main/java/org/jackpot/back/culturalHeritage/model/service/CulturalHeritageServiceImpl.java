...
public class CulturalHeritageServiceImpl implements CulturalHeritageService{
    ...
    @Override
    public List<CulturalHeritageRedis> getCulturalHeritageList() {
        try {
    ...
    @Override
    public List<CulturalHeritageRedis> getCulturalHeritageDistanceList(GetCulturalHeritageDistanceListRequest getCulturalHeritageDistanceListRequest) {
