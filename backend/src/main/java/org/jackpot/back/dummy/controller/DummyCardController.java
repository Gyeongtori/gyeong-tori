...
public class DummyCardController {
     ...
     */
     ...
     public ResponseEntity dummyList(@RequestBody DummyGetCardListRequest dummyGetCardListRequest){
         ...
         cardGradeDtoList1.add(new CardGradeDto(1L, 1, Arrays.asList(new Date("2024-01-01"), new Date("2024-01-02"), new Date("2024-01-03"))));
         cardGradeDtoList1.add(new CardGradeDto(2L, 2, Arrays.asList(new Date("2024-01-02"), new Date("2024-01-03"))));
         cardGradeDtoList1.add(new CardGradeDto(3L, 3, null));
         cardGradeDtoList1.add(new CardGradeDto(4L, 4, Arrays.asList(new Date("2024-01-06"))));
         cardGradeDtoList1.add(new CardGradeDto(5L, 5, null));
         readCardResponseList.add(new ReadCardResponse(320, "경주 불국사 다보탑", "경북", "경주시", "경북 경주시 불국로 385", cardGradeDtoList1,
         ...
         cardGradeDtoList2.add(new CardGradeDto(6L, 1, Arrays.asList(new Date("2024-01-01"), new Date("2024-01-02"), new Date("2024-01-03"))));
         cardGradeDtoList2.add(new CardGradeDto(7L, 2, Arrays.asList(new Date("2024-01-02"), new Date("2024-01-03"))));
         cardGradeDtoList2.add(new CardGradeDto(8L, 3, Arrays.asList(new Date("2024-01-11"))));
         cardGradeDtoList2.add(new CardGradeDto(9L, 4, Arrays.asList(new Date("2024-01-06"), new Date("2024-01-30"))));
         cardGradeDtoList2.add(new CardGradeDto(10L, 5, Arrays.asList(new Date("2024-01-23"))));
         readCardResponseList.add(new ReadCardResponse(321, "경주 불국사 삼층석탑", "경북", "경주시", "경북 경주시 불국로 385 불국사", cardGradeDtoList2,
